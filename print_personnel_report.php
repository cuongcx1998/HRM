...
<center>
    ...
    <div class="filterss" style="float: right; margin-right: 120px;" onload="refresh();">
        ...
        <input id="btnExport" type="button" value="Export to Word" style="float: right; margin-top: 30px; margin-right: -86px;">
	...
	?>
            <table id = "example" class = "stripe order-table" cellspacing = "0" style="margin: 10px;">
                <tr>
                    <td colspan = "5" class = "page-header"> <b>HỒ SƠ</b></td>	
		</tr>
		<tr>
                    <td >
		...
		<tr>
			<td colspan = "5" class = "page-header">TRÌNH ĐỘ ĐÃ ĐẠT</label>
		</tr>
		<tr>
                    <td colspan="2">
                            <b>Bằng cử nhân</b><br>
...
$("#btnExport").click(function (e) {
    ...
    var data_type = 'data:application/mswordl;charset=utf-8';
...
//    css_html = css_html.replace(/ /g, '%20');
    ...
    a.download = 'Bao cao ca nhan_' + postfix + '.doc';
