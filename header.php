            ...
            <div class="menu">
                ...
                <div class="dtime">
                    <div class="alert alert-info">
                        <i class="icon-calendar"></i><span><i>HAVE A GOOD WORKING DAY!</i></span><br>
                ...
                <?php
                  include("connect.php"); 
                    ...
                    if ($gender == "Nam") { ?>
                        ...
                        <span>Mr. <?php echo $row['per_lastname']. " " . $row['per_middlename']. " " . $row['per_firstname']; ?></span><br>
                        <span>Tuổi: <?php echo $difference; ?></span><br>
                        <span>Số điện thoại: <?php echo $row['per_contact_no']; ?></span><br>
                        <span>Bộ môn: <?php echo $row['per_campus']; ?></span><br><br>
                   <?php } else { ?>
                        
                        <span>Ms/Mrs. <?php echo $row['per_lastname']. " " . $row['per_middlename']. " " . $row['per_firstname']; ?></span><br>
                        <span>Tuổi: <?php echo $difference; ?></span><br>
                        <span>Số điện thoại: <?php echo $row['per_contact_no']; ?></span><br>
                        <span>Bộ môn: <?php echo $row['per_campus']; ?></span><br>
                  <?php  }
                  }
                ?>
                    </div>
